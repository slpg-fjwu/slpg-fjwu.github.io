...
<style>
a.hf-link {
  color: var(--global-theme-color, #4338ca);
...
<div class="marquee-wrap" style="overflow: hidden; position: relative; margin: 1rem 0 2rem; background: #4338ca; border-radius: 12px; padding: 0.9rem 0; -webkit-mask-image: linear-gradient(90deg, transparent, #000 8%, #000 92%, transparent); mask-image: linear-gradient(90deg, transparent, #000 8%, #000 92%, transparent);">
